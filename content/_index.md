...
I built this site using modern docs-as-code practices: git for version control, Hugo for static site generation, GitHub Actions for CI/CD, and Vale with the Microsoft Style Guide for quality checks. You can view the source of my site at [github.com/ebberg/portfolio](https://github.com/ebberg/portfolio/).

## About the samples

I wrote documentation for open-source projects I know well:

[Alertmon](https://github.com/foursquare/alertmon): I wrote this alerting tool. My documentation combines my deep product understanding with user empathy.
...
2. [Introducing rpmbuild]({{< ref "docs/introducing-rpmbuild.md" >}})
3. [Introducing alertmon]({{< ref "docs/introducing-alertmon.md" >}})
