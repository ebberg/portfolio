...
To learn how to create an alert, see [Creating an alert with alertmon](/docs/creating-an-alert-with-alertmon/).

To view the reference manual, see [Alertmon Reference](/docs/alertmon-reference/).
